...
cl = LINETCR.LINE()
cl.login(token="EqEaGWNqNofcTU8bCw84.wOkmirNWe41AVCDdjgw/za.kGZ+okfqeArTrVaPjOyw/Q6EvBPmD7mGr9ZsSqX7tt8=")
cl.loginResult()

#kt = LINETCR.LINE()
#kt.login(token="EqBL2TOTZwuxyia2JiA1.RNY0mD5hMgMbcfE1tEAyWq.BaHsY25Yc56xLUGZuWas+91TDJXb1vYl69OydkX5Zv4=")
#kt.loginResult()

#ks = LINETCR.LINE()
#ks.login(token="EqBL2TOTZwuxyia2JiA1.RNY0mD5hMgMbcfE1tEAyWq.BaHsY25Yc56xLUGZuWas+91TDJXb1vYl69OydkX5Zv4=")
#ks.loginResult()

#ki = LINETCR.LINE()
#ki.login(token="EqBL2TOTZwuxyia2JiA1.RNY0mD5hMgMbcfE1tEAyWq.BaHsY25Yc56xLUGZuWas+91TDJXb1vYl69OydkX5Zv4=")
#ki.loginResult()

#kk = LINETCR.LINE()
#kk.login(token="EqBL2TOTZwuxyia2JiA1.RNY0mD5hMgMbcfE1tEAyWq.BaHsY25Yc56xLUGZuWas+91TDJXb1vYl69OydkX5Zv4=")
#kk.loginResult()

#kc = LINETCR.LINE()
#kc.login(token="EqBL2TOTZwuxyia2JiA1.RNY0mD5hMgMbcfE1tEAyWq.BaHsY25Yc56xLUGZuWas+91TDJXb1vYl69OydkX5Zv4=")
#kc.loginResult()
...
#============================================================
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
#===============================================================
            elif 'Gruplist' in msg.text.lower():
              if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                if wait["protectionOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"turned into high protection\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["Qrblok off","qrblok off"]:
              if msg.from_ in admin:
                if wait["qr"] == False:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already off\n\n"+ datetime.today().strftime('%H:%M:%S'))
#≠≠================≠==================≠====≠===========!=======!==!
	    elif msg.text in ["Reinvite:off","reinvite:off"]:
              if msg.from_ in admin:
                if wait["autorein"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already off\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["Reinviteon","reinvite:on"]:
              if msg.from_ in admin:
                if wait["autorein"] == True:
                    if wait["lang"] == "JP":
              ...
              if msg.from_ in admin:
                if wait["welcomemsg"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"welcome message on")
            elif msg.text in ["Qrblok:on","qrblok:on"]:
              if msg.from_ in admin:
                if wait["qr"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Already on\n\n"+ datetime.today().strftime('%H:%M:%S'))
...
#===========================================
              ...
              if msg.from_ in admin:
                ...
                ks.sendText(msg.to,"kalian mantap")
	   	kt.sendText(msg.to,"😗😗😗😗😗😗")
#========================================
...
#------------------------------------------------------------------------------------
        ...
        if op.type == 32:
			OWN = "ub3808de9f7df35f57fb366d157f9790a"
			if op.param2 in Bots and admin:
				pass
			else:
				Inviter = op.param3.replace("",',')
...
#===========================================
        if op.type == 55:
            try:
				if op.param1 in wait2['readPoint']:
					X = cl.getContact(op.param2).displayX
					if X in wait2['readMember'][op.param1]:
						pass
					else:
						wait2['readMember'][op.param1] += "\n╠" + X
						wait2['ROM'][op.param1][op.param2] = "╠" + X
				else:
					cl.sendText
            except:
                pass
