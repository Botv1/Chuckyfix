...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="Es3ZoqGBqWz0aEXIJY1d.AiuDauRno6zp87MMtt5NRq.rXFoqi/LS2srihfTZdy2zag6ywTU/IaCBFhfy44K3WE=")
cl.loginResult()

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token="EsKVcCmEPUoTwk06Q5k1.RNY0mD5hMgMbcfE1tEAyWq.PEdiW3Du2aUU3y+b6YwgJ5iuOFyei+BbCsxN1/+nE8w=")
ki.loginResult()

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token="EsMDpV0hFlMlKgk4REie.pYxjKbe7w+1iIyyJvihN7G.QRip1SUpfQs9EvO8z2gh42F8NEAStJEPsT5JpyZ6jYk=")
kk.loginResult()

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token="EsK40MxYiTqu05FoDB71.8nezDhK7HGW9hVtLK4qvGq.n8kjZ0Pb+WiCrmEPJ/Nd01WEAv9gNgsRNP4foW/RyL0=")
kc.loginResult()

ks = LINETCR.LINE()
#ks.login(qr=True)
ks.login(token="EsycpG0Zx1Dc1UNluQ17.B1SXxj/vzd0tDPyYfa16jW.a11jwnp3XlBOHzadwbDtlrgyYIAmCkkDw7ojX6tIHbc=")
ks.loginResult()

satpam = LINETCR.LINE()
#satpam.login(qr=True)
satpam.login(token="EsneELS8L1sBr4SMmKP8.9sY37/mZOkHTT1mJDPli2a.e1QMvmg/dSUUgQK0QEkcaL577mlfXFSmrSpQQHxwtE0=")
satpam.loginResult()
...
-==================-
[•] Gn (ganti nama grup)
[•] Help (kode perintah bot)
[•] Mimin (admin menu)
}•] Nk @ (kick tag
[•] #salam (Semua bot ngkick)
[•] Kick @ (Kicker masuk)
[•] ## (semua bot ngekick)
[•] Bom (Kick tag)
[•] Responkick on/off
[•] Kick (kick mid)
[•] Invite (invite mid)
[•] Admin add @ (tambah admin di tag)
[•] Admin remove @
[•] Allbio: (merubah bio bot)
[•] Myname
[•] Spam (spam on 10 kata2)
[•] Spamcontact @ (kirim spam ke kontak/inbok kontak)
[•] Up (spam)
[•] Gbc (broadcast ke semua grup yg ada bot nya)
[•] Bc (broadcast tekt)
[•] LG/LG2 (liat daftar grup)
[•] Bot bye (klr dari smua grup)
[•] Bot like"""
...
[•] Speed/Sp
[•] Tes speed
[•] Time (lihat jam hari tgl & tahun)
[•] Runtime (lihat jam bot on)
[•] Tiru on
[•] Tiru off
[•] Tiru add @ (tag utk meniru)
[•] Tiru del @ (tag utk memadam tiruan)
[•] Tiru list
[•] Tiru target
-===========-
Clab Ehun bot
...
☆ NRS_FAMILY ☆
☆ EHUN BOT PROTECT ☆
☆ SMULE @NRS_EHUN @VS1_EHJN ☆
☆ OWNER COMMUNITY ☆
☆ ASOSIATION OWNER INDONESIA ☆
☆ Generasi Kickers Killers ☆

Minat? Silahkan PM!
Idline: http://line.me/ti/p/~sarehun""",
    "lang":"JP",
...
def bot(op):
    try:
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        cl.sendText(op.param1, "Hai kak" + "☞ " + Name + " ☜" + "\nNgintip Aja Niih. . .\nChat Kek Idiih (-__-)   \nJam :" + datetime.today().strftime('%H:%M:%S'))
                                        time.sleep(0.0001)
                                        mention2(op.param1,[op.param2])
                                    else:
                                        cl.sendText(op.param1, "Hai kak" + "☞ " + Name + " ☜" + "\nSini gabung chat\nKak baru bangun ya (-_-) \nJam :" + datetime.today().strftime('%H:%M:%S'))
                                        time.sleep(0.0001)
                                        mention2(op.param1,[op.param2])
                                else:
                                    cl.sendText(op.param1, "Hai kak" + "☞ " + Name + " ☜" + "\nNgintip Aja Niih. . .\nChat Kek Idiih (-__-)   \nJam :" + datetime.today().strftime('%H:%M:%S'))
                ...
                if op.param1 in wait['pname']:
                    ...
                    try:
                       cl.updateGroup(G)
                        ...
                        pass
                        #cl.sendText(op.param1,"Kak jgn tukar nama group...\nMaaf kami kick kamu kak\nJam :" + datetime.today().strftime('%H:%M:%S'))
                    else:
                        try:
                           cl.kickoutFromGroup(op.param1,[op.param2])
                        except:
                            pass
                        random.choice(KAC).sendText(op.param1,"Kak jgn tukar nama group...\nMaaf aku kami kick kamu kak\nJam :" + datetime.today().strftime('%H:%M:%S'))
                        m = Message(to=op.param1,from_=None, text=None, contentType=13)
                        m.contentMetadata={'mid':op.param2}
                        random.choice(KAC).sendMessage(m)
        if op.type == 11:
            if op.param3 == '2':
                if op.param1 in wait['icon']:
                    try:
                       G = random.choice(KAC).getGroup(op.param1)
                    except:
                        pass
                    G.name = wait['pro_icon'][op.param1]
                    try:
                       random.choice(KAC).sendText(op.param1,"Kak jgn tukar logo group\nMaaf kami kick kamu")
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                    ...
                    balas = ["Hai kak " + cName + "Jgn ngetag!!!! \nRibut hoyyy (-_-) ","Jgn ngtag lagi hoyy\nRibut tauk","Aku bilang jgn ngtag lagi\nNanti Ku kick kamu kak"]
                    balas1 = ["Awas kak" + cName + "Ku bilang jgn ngetag \nMaaf ku kick kamu kak"]
                    ret_ = random.choice(balas)
                    #ret = random.choice(balas1)
                    name = re.findall(r'@(\w+)', msg.text)
                    mention2 = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention2['MENTIONEES']
                    for mention2 in mentionees:
                         if mention2['M'] in Bots:
                                cl.sendText(msg.to,ret_)
                                cl.kickoutFromGroup(msg.to,[msg.from_])
                         if mention2['M'] in admin:
                                cl.sendText(msg.to,ret_)
                                cl.kickoutFromGroup(msg.to,[msg.from_])
                         if mention2['M'] not in Bots:
                                cl.sendText(msg.to,ret_)
                                cl.kickoutFromGroup(msg.to,[msg.from_])
                                break
        ...
        if op.type == 19:
          if op.param3 in induk: #induk ke kick
              cl.acceptGroupInvitation(op.param1)
        ...
        if op.type == 19:
          if op.param3 in admin: #Admin ke Kick
            if op.param2 in Bots:
              pass
...
#--------------------------------
        ...
        if op.type == 26:
            ...
            elif msg.text in ["Help owner"]:
                    cl.sendText(msg.to,ownerMessage)

            elif msg.text in ["Help room"]:
                    cl.sendText(msg.to,roomMessage)
    ...
    #-----------Sider-------#
                ...
                wait["Sider"] = True
                cl.sendText(msg.to,"Siap on cek yg ngintip boss")

            elif msg.text in ["Sider off"]:
                  if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    wait["Sider"] = False
                    cl.sendText(msg.to, "Cek pengintip off")
                  else:
                    cl.sendText(msg.to, "Heh Belom Di on boss")

            elif "Namelock on" in msg.text:
                if msg.to in wait['pname']:
                    cl.sendText(msg.to,"ƬƲƦƝЄƊ ƠƝ.  +nJam :" + datetime.today().strftime('%H:%M:%S'))
                else:
...
#wait["kickMention"] = True
                  ...
                  wait["kickMention"] = True
                  cl.sendText(msg.to,"Respon kick on")
              else:
 ...
 #----------Invit contact------#
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to, "Kakak siapa?")
 #------Bot buat room baru--#
            elif "Room baru" in msg.text:
              if msg.from_ in admin:
                thisgroup = cl.getGroups([msg.to])
                Mids = [contact.mid for contact in thisgroup[0].members]
                mi_d = Mids[:33]
                cl.createGroup("Room baru", mi_d)
                cl.sendText(msg.to,"Success invite member ke Room baru")
              else:
                cl.sendText(msg.to, "Kakak siapa?")
...
#----------Jam bot on---#
 ...
 #---------Jam Tgl hari tahun--#
               ...
               hari = ["Minggu", "Senin", "Selasa", "Rabu", "Khamis", "Jum'at", "Sabtu"]
              ...
              if msg.from_ in owner:
                if 'MENTION' in msg.contentMetadata.keys()!= None:
                     ...
                     for mention in mentionees:
                         ...
                         cl.sendText(msg.to,"Dada kak\nLain kali Jgn nakal ya kak")

            elif msg.text in ["Restart"]:
              if msg.from_ in admin:
                  cl.sendText(msg.to, "Ehun Bot di Restart. \nJam :" + datetime.today().strftime('%H:%M:%S'))
                  restart_program()
                  print "@Restart"
              else:
 ...
 #-------Mimic-----------#
              ...
              #if msg.from_ in admin:
                targets = []
                key = eval(msg.contentMetadata["MENTON"])
                key["MENTIONEES"][0]["M"]
                ...
                for target in targets:
                    try:
                        ...
                        cl.sendText(msg.to,"Target di tambah")
                        break
                    except:
                ...
                for target in targets:
                    try:
                       ...
                       cl.sendText(msg.to,"Target dihapus")
                       break
                    except:
                       cl.sendText(msg.to,"Fail !")
                       break
    ...
    #------mmmSC AllBio=---------------- Ganti Bio Semua Bot Format => Allbio: SUKA SUKA KALIAN :D
...
#----------------------------------------------------------------------------                
            ...
            elif msg.text in ["å¼·åˆ¶è‡ªå‹•é€€å‡º:ã‚ªãƒ•","Leave off","Auto leave:off","å¼·åˆ¶è‡ª��‹•é€€å‡ºï¼��é—œ"]:
              if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                ...
                if wait["namelockOn"] == True: md+="Namelock : on\n"
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to, "Lagi Cek CCTV")
                try:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
              ...
              if msg.from_ in owner:
                ...
                G.preventJoinByTicket = True
                cl.updateGroup(G)
                cl.sendText(msg.to,"Semua Sudah Lengkap Boss")
    ...
    #-------------Fungsi Tag All Start---------------#
            ...
            elif msg.text in ["Tagall","Mention","Abah"]:
            	 if msg.from_ in admin:              
                  group = cl.getGroup(msg.to)
                  nama = [contact.mid for contact in group.members]
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Saya Luffy Tukang Ngintip On")
                ki.sendText(msg.to,"Saya Zorro Tukang Nikung On")
                kk.sendText(msg.to,"Saya Sanji Tukang Mojok On")
                kc.sendText(msg.to,"Saya Ussop Tukang Baper On")
                ks.sendText(msg.to,"Saya Choper Tukang Ngocok On")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
