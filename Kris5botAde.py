...
#cl.login(qr=True)
cl.login(token="Eq4fTI6BOmf46WC8WTe9.DoWKKaVjwh/naOep1ooa6q.p+sLyByUA9GLengI1IochqpP7XO5tTWx8y8ZjhSFkYQ=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
#ki.login(qr=True)
ki.login(token="Eq4fTI6BOmf46WC8WTe9.DoWKKaVjwh/naOep1ooa6q.p+sLyByUA9GLengI1IochqpP7XO5tTWx8y8ZjhSFkYQ=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
#kk.login(qr=True)
kk.login(token="Eq4fTI6BOmf46WC8WTe9.DoWKKaVjwh/naOep1ooa6q.p+sLyByUA9GLengI1IochqpP7XO5tTWx8y8ZjhSFkYQ=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
#kc.login(qr=True)
kc.login(token="Eq4fTI6BOmf46WC8WTe9.DoWKKaVjwh/naOep1ooa6q.p+sLyByUA9GLengI1IochqpP7XO5tTWx8y8ZjhSFkYQ=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
#ks.login(qr=True)
ks.login(token="Eq4fTI6BOmf46WC8WTe9.DoWKKaVjwh/naOep1ooa6q.p+sLyByUA9GLengI1IochqpP7XO5tTWx8y8ZjhSFkYQ=")
ks.loginResult()

satpam = LINETCR.LINE() # 
satpam.login(token="Eq4fTI6BOmf46WC8WTe9.DoWKKaVjwh/naOep1ooa6q.p+sLyByUA9GLengI1IochqpP7XO5tTWx8y8ZjhSFkYQ=")
...
helpMessage ="""҉R҉i҉d҉e҉r҉ ҉C҉l҉u҉b҉ ҉O҉n҉e҉ ҉P҉i҉e҉c҉e҉ ҉P҉r҉o҉t҉e҉c҉t҉
Owner : ✰Ќriֆ✰
-==================-
◄]·♦·Menu For Public·♦·[►
[•]Adminlist
...
[•]Bot
"""
Keyowner ="""҉R҉i҉d҉e҉r҉ ҉C҉l҉u҉b҉ ҉O҉n҉e҉ ҉P҉i҉e҉c҉e҉ ҉P҉r҉o҉t҉e҉c҉t҉
Owner : ✰Ќriֆ✰
-==================-
◄]·♦·Menu For Owner·♦·[►
[•]Gn (ganti nama grup)
...
👑Hanya Untuk Owner👑
-==================-
҉R҉i҉d҉e҉r҉ ҉C҉l҉u҉b҉ O҉n҉e҉ ҉P҉i҉e҉c҉e҉ ҉P҉r҉o҉t҉e҉c҉t҉
-==================-
"""
KAC=[cl,ki,kk,kc,ks]
...
induk=[mid]
induk2=[Amid,Bmid]
admin=["u31ef22df7f538df1d74dc7f756ef1a32","u9cc2323f5b84f9df880c33aa9f9e3ae1","uece14c5ae46691f48f03c4fd331c3fd8","u6908b4803bf3e267cf659ddda91d5fa4","u60335d94c7a3ca3a3c3685f515724145","uc92d7e39d7259174dba7d8028c7ef4b2","uc1ba312554b4ee025039f54ff44c7c7f","u8197906b2cc18e992fd6bd63d3dac867"] #Krisna,kris,ke 5 bot
owner=["u31ef22df7f538df1d74dc7f756ef1a32","u9cc2323f5b84f9df880c33aa9f9e3ae1","uece14c5ae46691f48f03c4fd331c3fd8","u6908b4803bf3e267cf659ddda91d5fa4","u60335d94c7a3ca3a3c3685f515724145","uc92d7e39d7259174dba7d8028c7ef4b2","uc1ba312554b4ee025039f54ff44c7c7f"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["One piece"]: #Panggil Semua Bot
              if msg.from_ in owner:
